    ...
    <div className="overflow-x-auto">
      <table className="min-w-full divide-y divide-zinc-200/60">
        <thead className="bg-zinc-50/50">
          <tr>
            <th className="px-6 py-4 text-left text-xs font-bold text-zinc-500 uppercase tracking-wider">Sección</th>
            <th className="px-6 py-4 text-left text-xs font-bold text-zinc-500 uppercase tracking-wider hidden md:table-cell w-1/4">Progreso</th>
            <th className="px-6 py-4 text-center text-xs font-bold text-zinc-500 uppercase tracking-wider">Total</th>
            <th className="px-6 py-4 text-center text-xs font-bold text-zinc-500 uppercase tracking-wider">Pegadas</th>
            <th className="px-6 py-4 text-center text-xs font-bold text-zinc-500 uppercase tracking-wider">Repetidas</th>
            <th className="px-6 py-4 text-right text-xs font-bold text-zinc-500 uppercase tracking-wider">%</th>
            <th className="relative px-2 py-4"><span className="sr-only">Ir al detalle</span></th>
          </tr>
        </thead>
          ...
          {data.map((item, index) => {
            ...
            return (
              <tr key={index} className="hover:bg-zinc-50/80 transition-colors group cursor-pointer" onClick={() => onGoToDetail(item.section)}>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-zinc-500 font-medium text-center">{item.needed}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-zinc-900 text-center font-black">{uniqueCount}</td>
                ...
                <td className="px-2 py-4 whitespace-nowrap text-right text-sm font-medium pr-6">
